  ...
  <header id="header" class="fixed-top d-flex align-items-center">
    <div class="container d-flex align-items-center">
      ...
      <nav id="navbar" class="navbar order-last order-lg-0">
        <ul>
          <li><a class="nav-link scrollto active" href="${pageContext.request.contextPath}#hero">Home</a></li>
            ...
            <div class="portfolio-details-slider swiper">
              <div class="swiper-wrapper align-items-center">
                ...
                <div class="swiper-slide">
                  <img src="${pageContext.request.contextPath}/mediserve_image/mediserveProduct/${prod.pPhoto}" alt="" style ="height:600px" />
                </div>
               ...
               <div class="container-fluid">
                                        <div class="row">
                                            ...
                                            <form action="${pageContext.request.contextPath}/user/cart/add"
                                                ...
                                                <div class="form-group">
                                                    <button type="submit" name="add to cart" value="submit"
